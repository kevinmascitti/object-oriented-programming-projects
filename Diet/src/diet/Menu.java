...
public class Menu implements NutritionalElement {
	...
	public Menu(String name, SortedMap<String, NutritionalElement> recipes, SortedMap<String, NutritionalElement> materials, SortedMap<String, NutritionalElement> products) {
		this.name = name;
		this.recipesbook=recipes;
		this.productsbook=materials;
		this.productsbook.putAll(products);
