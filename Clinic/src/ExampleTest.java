...
public class ExampleTest {
	...
	public void test() throws NoSuchPatient, NoSuchDoctor, IOException {
		...
		hospital.loadData(r);
		hospital.addDoctor("Sam", "Smith", "SAMSMT",4,"Physician");
		hospital.addDoctor("John", "Poll", "JHNPLL",5,"Physician");
		hospital.addDoctor("Jay", "Zon", "JAYZON",8,"Physician");
		hospital.idleDoctors();
		*/
