...
public class Food {	
	...
	public SortedMap<String, NutritionalElement> rawMaterialsMAP(){
		return materials;
	}
	...
	public SortedMap<String, NutritionalElement> productsMAP(){
		return products;
	}
	...
	public SortedMap<String,NutritionalElement> recipesMAP(){
		return recipes;
	}
	...
	public Menu createMenu(String name) {
		Menu a = new Menu(name, recipes, materials, products);
		menues.put( name, a );
		return a;
	}
